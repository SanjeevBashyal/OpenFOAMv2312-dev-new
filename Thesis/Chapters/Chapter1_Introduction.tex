...
\begin{itemize}
	...
	\item To develop a model that combines 3D turbulence modeling techniques of finite volume method with discrete element method in the body fitted immersed boundary mesh to simulate particle transport processes during fluid flow.
