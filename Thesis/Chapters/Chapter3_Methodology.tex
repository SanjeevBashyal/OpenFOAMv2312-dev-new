...
This section details the validation of the developed solver through fundamental test cases and comparative analysis with existing state-of-the-art solvers.

\subsection{Fundamental Validation Test Cases}

To rigorously validate the developed solver, four fundamental test cases are established. These cases isolate specific physics: mechanical contact (DEM) and fluid-structure interaction (CFD-DEM).
