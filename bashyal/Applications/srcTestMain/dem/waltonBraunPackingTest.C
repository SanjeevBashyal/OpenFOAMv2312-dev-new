...
-------------------------------------------------------------------------------
Description
    Test Case: Walton-Braun Packing Test
    Validates multi-body contacts with hysteretic damping (Walton-Braun model).
...
{
    Info << "\n========================================\n"
         << "Test Case: Walton-Braun Packing\n"
         << "========================================\n" << Foam::endl;
    ...
    // Instantiate with kUnloading > k for Walton-Braun model
    contactForce forceComputer(k, kUnloading, k, gammaN, 0.0, mu);
    
    timeRegistry timeReg(dt, endTime, "VTK_WaltonBraun");
    timeReg.setWriteInterval(0.05);
    
    // Register walls
    timeReg.addStaticObject("floor", "VTK_WaltonBraun/floor.vtp");
    timeReg.addStaticObject("wallL", "VTK_WaltonBraun/wallL.vtp");
    timeReg.addStaticObject("wallR", "VTK_WaltonBraun/wallR.vtp");
    timeReg.addStaticObject("wallB", "VTK_WaltonBraun/wallB.vtp");
    timeReg.addStaticObject("wallF", "VTK_WaltonBraun/wallF.vtp");
    
    std::ofstream dataFile("walton_braun_data.csv");
