...
\begin{equation}
	e = \sqrt{\frac{k_1}{k_2}}
\end{equation}
\equations{Analytical Coefficient of Restitution}
...
\begin{itemize}
	...
	\item \textbf{Contact Model:} Walton-Braun Hysteretic Spring model with Coulomb Friction model.
	\begin{itemize}
		\item Loading Stiffness: $k_1 = 1 \times 10^5 \, N/m$.
		\item Unloading Stiffness: $k_2 = 1.5 \times 10^5 \, N/m$.
...
\end{equation}
\equations{Force Balance for Settling Particle}
...
\end{equation}
\equations{Archimedes' Principle for Floating Cube}
...
\begin{figure}[ht]
	\centering
	\includegraphics[width=0.9\textwidth]{Figures/Chapters/C03/sediment_bed_sim.png}
