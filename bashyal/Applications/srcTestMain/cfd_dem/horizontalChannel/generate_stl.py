...
def write_cube_stl(filename, size):
    ...
    with open(filename, 'w') as f:
        f.write(f"solid cube_{size*1000}mm\n")
        for face in faces:
            ...
            f.write("endloop\n")
            f.write("endfacet\n")
        f.write(f"endsolid cube_{size*1000}mm\n")

if __name__ == "__main__":
    # 3mm cube
    write_cube_stl("constant/triSurface/cube_3mm.stl", 0.003)
    print("Generated constant/triSurface/cube_3mm.stl")
